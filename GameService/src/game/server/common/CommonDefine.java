...
public class CommonDefine {
    ...
    public static final String[] LIST_GAME = {"Choose Game", "Cờ Caro", "Bầu Cua", "Boom!!!"};
    public static final String[] LIST_ACTION = {"CHOOSE", "Update Coin", "Block Chat", "Update LvL Dxh", "Client Rename", "Base Reward Dxh", "Show Coin All", "Reinit MapData"};
    public static final int UPDATE_COIN = 1;
    public static final int BLOCK_CHAT = 2;
    public static final int UPDATE_LEVEL_DXH = 3;
    public static final int ALLOW_RENAME = 4;
    public static final int UPDATE_REWARD_DXH = 5;
    public static final int SHOW_COIN_ALL = 6;
    public static final int GENERATE_MAP_DXH = 7;
    ...
    public static final Color CARO_COLOR_X = new Color(217, 98, 98);
    public static final Color CARO_COLOR_O = new Color(105, 216, 119);
